...
-- SQL Grouping sets allows to return specific aggregated groupings which is required 
-- to return multiple grouping sets values 
...
GROUP BY GROUPING SETS(P.FirstName + ' ' + P.LastName),(S.Name),
